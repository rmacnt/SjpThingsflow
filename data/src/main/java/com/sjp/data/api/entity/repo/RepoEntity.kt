...
data class RepoEntity (
    ...
    var title: String?,
    @SerializedName("user")
    var user: RepoUserEntity?,
    @SerializedName("labels")
    var labels: ArrayList<RepoLabelEntity?>,
    @SerializedName("state")
    var state: String?,
    @SerializedName("locked")
    var locked: Boolean?,
    @SerializedName("assignee")
    var assignee: RepoAssigneesEntity?,
    @SerializedName("assignees")
    var assignees: ArrayList<RepoAssigneesEntity>?,
    ...
    var reactions: RepoReactionsEntity?,
